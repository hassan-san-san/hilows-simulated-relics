...
// stats2pc / stats4pc contain UNCONDITIONAL passive stat bonuses only.
// Values are in decimal form: 0.16 = 16%, 0.06 = 6%, etc.
// Conditional bonuses (triggered by skill use, enemy state, ally presence, etc.) are omitted.
// Guard of Wuthering Snow 2pc (DMG reduction) and Ashblazing 2pc (follow-up DMG type) are
// not standard character stats and are omitted.
...
export const RELIC_SETS = {
    cavern: [
        ...
        },
        {
            ...
            stats2pc: null, // DMG taken reduction is a combat mechanic, not a character stat
            stats4pc: null,
        },
        {
            ...
            stats4pc: null, // SPD and CRIT DMG conditional on memosprite being on field
        },
        {
        ...
        },
        {
            ...
            stats2pc: { atkPct: 0.12 },
            stats4pc: { spdPct: 0.06 }, // SPD +6% is always-on; Basic ATK DMG% excluded
        },
        {
        ...
        },
        {
            ...
            stats2pc: null, // DMG conditional on enemy having debuffs
            stats4pc: { critRate: 0.04 }, // Base 4% CRIT Rate is always-on; CRIT DMG boosts are conditional
        },
        {
            ...
            stats2pc: { quantumDmg: 0.10 },
            stats4pc: { spdPct: -0.08 }, // SPD -8% is always-on; CRIT Rate conditional on SPD threshold
        },
        {
        ...
        },
        {
            ...
            stats4pc: null, // Extra shield + CRIT DMG conditional on ally having wearer's shield
        },
        {
            ...
            stats2pc: null, // Follow-up ATK DMG type bonus, not a base character stat
            stats4pc: null,
        },
        {
            ...
            stats2pc: { atkPct: 0.12 },
            stats4pc: { critRate: 0.06 }, // CRIT Rate +6% is always-on; Ultimate DMG% on follow-up conditional
        },
        {
            ...
            stats2pc: { breakEffect: 0.16 },
            stats4pc: { breakEffect: 0.16 }, // Break Effect +16% is always-on; Energy regen conditional
        },
        {
            ...
            stats2pc: { spdPct: 0.06 },
            stats4pc: null, // Gentle Rain SPD/CRIT DMG requires healing trigger
        },
        {
    ...
    planar: [
        {
            ...
            bonus4pc: "",
            stats2pc: { critRate: 0.08 }, // CRIT Rate always-on; SPD for allies requires memosprite
        },
        {
        ...
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { defPct: 0.15 }, // First 15% always-on; extra 15% conditional on Effect Hit Rate
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { hpPct: 0.12 }, // HP always-on; CRIT DMG conditional on HP threshold
        },
        {
            name: "Broken Keel",
            id: 310,
            ...
            bonus4pc: "",
            stats2pc: { effectRes: 0.10 }, // Effect RES always-on; CRIT DMG conditional on RES threshold
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { critDmg: 0.16 }, // CRIT DMG always-on; CRIT Rate conditional on threshold + first attack
        },
        {
        ...
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { atkPct: 0.12 }, // ATK always-on; DMG conditional on SPD threshold
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { hpPct: 0.12 }, // HP always-on; ATK for allies conditional on SPD threshold
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { spdPct: 0.06 }, // SPD always-on; Break Effect conditional on fire weakness
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { spdPct: 0.06 }, // SPD always-on; Healing conditional on SPD threshold
        },
        {
            name: "Inert Salsotto",
            id: 306,
            ...
            bonus4pc: "",
            stats2pc: { critRate: 0.08 }, // CRIT Rate always-on; DMG conditional on CRIT Rate threshold
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { atkPct: 0.12 }, // ATK always-on; CRIT Rate conditional on team comp
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { energyRegen: 0.05 }, // Energy Regen always-on; ATK for first char conditional on position
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { effectHitRate: 0.10 }, // Effect Hit Rate always-on; ATK scaling conditional on EHR value
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { energyRegen: 0.05 }, // Energy Regen always-on; DMG for same-type allies conditional
        },
        {
            ...
            bonus4pc: "",
            stats2pc: null, // Elation is a path-specific mechanic; CRIT DMG conditional on Elation threshold
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { atkPct: 0.12 }, // ATK always-on; DoT DMG conditional on ATK threshold
        },
        {
            name: "Rutilant Arena",
            id: 309,
        ...
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { critRate: 0.04 }, // CRIT Rate always-on; CRIT DMG conditional on kills
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { atkPct: 0.12 }, // First 12% always-on; extra 12% conditional on SPD threshold
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { energyRegen: 0.05 }, // Energy Regen always-on; action advance conditional
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { breakEffect: 0.16 }, // First 16% always-on; extra 20% conditional on SPD threshold
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { critDmg: 0.16 }, // CRIT DMG always-on; extra CRIT DMG conditional on SP usage
        },
        {
            ...
            bonus4pc: "",
            stats2pc: { critDmg: 0.16 }, // CRIT DMG always-on; extra CRIT DMG conditional on summon
        },
    ]
};

# Hilows Simulated Relics

A Honkai: Star Rail relic simulator that lets you pull, upgrade, and manage relics — built to feel like an actual gacha game rather than a dry stat calculator.
...
- Accurate relic generation — correct main stat weights, substat pools, and tiered roll values
...
- Relic images sourced from [Mar-7th/StarRailRes](https://github.com/Mar-7th/StarRailRes) — an excellent community resource for HSR game assets.
- Honkai: Star Rail is owned by HoYoverse. This is a fan project with no affiliation.
